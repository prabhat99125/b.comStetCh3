...
btn.addEventListener(("click"), () => {
    ...
    html += `</tr><tbody>`;
    html += `<table class="block"><tr><td>n<input type="number" class="nad"></td> <td>A<sub>2</sub><input type="number" class="nad"></td> <td>D<sub>3</sub><input type="number" value="0" class="nad"></td> <td>D<sub>4</sub><input type="number" class="nad"></td>  </tr></table>`;
